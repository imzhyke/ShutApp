...
<View style={{backgroundColor: 'white', padding: 10, margin: 10,flexDirection: 'row', width: '100%', borderRadius: 20, justifyContent: 'center', alignItems: 'center'}}>
<Icon
          name={'facebook'}
          size={34}
          color={"#5B00FF"}
          />
<Text style={{color: '#5B00FF', fontWeight: 'bold', marginLeft: 15}}>facebook.com/callmezyk00</Text>
