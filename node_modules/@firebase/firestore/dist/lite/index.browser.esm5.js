 ...
 * limitations under the License.
 */
var g = "9.22.1", w = new l("@firebase/firestore");
...
function nn(t, e) {
    ...
    var i = function(t) {
        if (0 !== t.length) return sn(Zt.create(t, "and" /* CompositeOperator.AND */));
    }(e.filters);
 ...
 */ function vn(t) {
    ...
    if (!mn.has(t)) {
        ...
        new $(i, o, a, u.host, u.ssl, u.experimentalForceLongPolling, u.experimentalAutoDetectLongPolling, ft(u.experimentalLongPollingOptions), u.useFetchStreams))), n = fn(t._databaseId), r = function(t, e, n, r) {
 ...
 */ function Tn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        if ("string" == typeof r.mockUserToken) a = r.mockUserToken, u = v.MOCK_USER; else {
            ...
            if (!s) throw new B(O, "mockUserToken must contain 'sub' or 'user_id' field!");
            u = new v(s);
        }
...
/** Parse update data from a list of field/value arguments. */ function tr(t, e, n, r, i, o) {
    var a = t.ft(1 /* UserDataSource.Update */ , e, n), u = [ ar(e, r, n) ], s = [ i ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    }(o.serializer, Ae(r), i), u = a.request, s = a.Z, c = u.parent, o.connection.g || delete u.parent, 
                    [ 4 /*yield*/ , o.R("RunAggregationQuery", c, u, /*expectedResponseCount=*/ 1) ];
